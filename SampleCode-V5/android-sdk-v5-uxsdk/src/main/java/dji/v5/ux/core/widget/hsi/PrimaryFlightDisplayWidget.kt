...
open class PrimaryFlightDisplayWidget @JvmOverloads constructor(
    ...
    private var fpv_attitude: AircraftAttitudeView? = null

    private lateinit var binding: UxsdkPrimaryFlightDisplayWidgetBinding

    private val widgetModel by lazy {
        PrimaryFlightDisplayModel(
    ...
    override fun initView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        binding =
            UxsdkPrimaryFlightDisplayWidgetBinding.inflate(LayoutInflater.from(context), this, true)
    }

    override fun reactToModelChanges() {
        addDisposable(
            widgetModel.velocityProcessor.toFlowable().observeOn(AndroidSchedulers.mainThread())
                .subscribe {
